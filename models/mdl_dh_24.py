...
val_data = torch.load('weights/cfg_dh_6c/fold0/val_data_seed982987.pth', map_location=torch.device('cpu') )
ckpt = torch.load('weights/cfg_dh_6c/fold0/checkpoint_last_seed982987.pth', map_location=torch.device('cpu') )
